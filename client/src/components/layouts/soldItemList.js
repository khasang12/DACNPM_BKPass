          ...
          <div className="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
            <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
              ...
              <div className="modal-body relative p-4 leading-loose">
                ...
                <h1 className="font-bold text-3xl text-blue-600 leading-loose"></h1>
                <h3>
                  ...
                  <div className="w-full px-2">
                    <form className="w-full">
                      ...
                      <ul className="flex w-2/3 mt-3 mb-5 md:grid-cols-2">
                        <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Phân loại</label>
                        ...
                        <li className="flex-1">
                          ...
                          <label
                            htmlFor="status-new"
                            className="inline-flex justify-center items-center p-2 md:min-w-1/2 text-gray-500 bg-white rounded-lg border border-gray-200 cursor-pointer peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100"
                          >
                            <div className="w-full">
                              Hàng mới
                            </div>
